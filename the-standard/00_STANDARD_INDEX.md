# 00_STANDARD_INDEX - The Standard
...
- **Minting a new orchestrator?** Work the §2 birth checklist top to bottom, build the §3 folder, write the §4 ceremony + contract pair, then run the §6 gate.
- **Reviewing one (the gatekeeper)?** Run §6: §2 checklist + §3.5 builder check + §4 pattern + the cross-link integrity check + the §3 layout, on both sides, before it is live.
- **Adding agents?** See §7 - your own library (path-explicit) versus the external reference you mine.
